...
const TEMPLATES: AgentTemplate[] = [
  // Business
  { id: 'ceo-advisor', name: 'CEO Advisor', category: 'Business', description: 'Acts as a strategic C-suite advisor. Helps with vision, decision-making, board communications, and business strategy.', model: 'claude-sonnet-4-6', color: '#7f77dd', Icon: TrendingUp, task: 'Act as my strategic CEO advisor. Help me with vision setting, major decisions, board communications, and overall business strategy. Be direct and think long-term.' },
  { id: 'cfo-advisor', name: 'CFO Advisor', category: 'Business', description: 'Financial strategy, cash flow analysis, budgeting, forecasting, and investor reporting.', model: 'gpt-4o', color: '#7f77dd', Icon: DollarSign, task: 'Act as my CFO advisor. Help me with financial strategy, cash flow, budgeting, forecasting, and investor reporting. Focus on the numbers and what they mean for the business.' },
  { id: 'coo-advisor', name: 'COO Advisor', category: 'Business', description: 'Operations optimization, process design, team structure, and execution planning.', model: 'claude-sonnet-4-6', color: '#7f77dd', Icon: Settings, task: 'Act as my COO advisor. Help me optimize operations, design efficient processes, structure my team, and build execution plans that scale.' },
  { id: 'business-plan', name: 'Business Plan Writer', category: 'Business', description: 'Creates comprehensive business plans with market analysis, financial projections, and go-to-market strategy.', model: 'claude-sonnet-4-6', color: '#7f77dd', Icon: FileText, task: 'Help me write a comprehensive business plan. Include market analysis, competitive landscape, financial projections, and a detailed go-to-market strategy.' },
  { id: 'startup-mentor', name: 'Startup Mentor', category: 'Business', description: 'Advises early-stage founders on product-market fit, fundraising, hiring, and growth.', model: 'claude-sonnet-4-6', color: '#7f77dd', Icon: Lightbulb, task: 'Act as my startup mentor. Guide me on product-market fit, fundraising strategy, early hiring decisions, and sustainable growth. Be honest and practical.' },
  { id: 'competitive-intel', name: 'Competitive Intelligence', category: 'Business', description: 'Researches competitors, analyzes positioning, and produces battlecards and SWOT analyses.', model: 'gpt-4o', color: '#7f77dd', Icon: BarChart2, task: 'Research my competitors, analyze their positioning, and help me build SWOT analyses and competitive battlecards I can use with my sales and product teams.' },

  // Marketing
  { id: 'cmo-advisor', name: 'CMO Advisor', category: 'Marketing', description: 'Full-stack marketing strategy, brand positioning, channel mix, and campaign planning.', model: 'claude-sonnet-4-6', color: '#f97316', Icon: Megaphone, task: 'Act as my CMO. Help me build a full marketing strategy — brand positioning, channel selection, budget allocation, and campaign planning.' },
  { id: 'campaign-manager', name: 'Campaign Manager', category: 'Marketing', description: 'Plans and executes multi-channel marketing campaigns with copy, targeting, and KPI tracking.', model: 'gpt-4o', color: '#f97316', Icon: BarChart3, task: 'Help me plan and execute a multi-channel marketing campaign. Define targeting, write copy variants, set KPIs, and create a tracking framework.' },
  { id: 'brand-strategist', name: 'Brand Strategist', category: 'Marketing', description: 'Develops brand identity, voice, messaging frameworks, and positioning statements.', model: 'claude-sonnet-4-6', color: '#f97316', Icon: Palette, task: 'Help me develop my brand identity — voice, tone, messaging framework, and a clear positioning statement that differentiates me in the market.' },
  { id: 'email-marketer', name: 'Email Marketer', category: 'Marketing', description: 'Writes email sequences, nurture campaigns, subject lines, and A/B test variants.', model: 'claude-sonnet-4-6', color: '#f97316', Icon: Mail, task: 'Write compelling email sequences and nurture campaigns. Include strong subject lines, A/B test variants, and optimize for open and conversion rates.' },
  { id: 'growth-hacker', name: 'Growth Hacker', category: 'Marketing', description: 'Identifies growth loops, runs experiments, and finds unconventional acquisition channels.', model: 'gpt-4o', color: '#f97316', Icon: Rocket, task: 'Help me identify growth loops, design rapid experiments, and find unconventional acquisition channels. Think creatively and data-driven.' },
  { id: 'market-researcher', name: 'Market Researcher', category: 'Marketing', description: 'Conducts market research, surveys analysis, TAM/SAM/SOM calculations, and trend reports.', model: 'gpt-4o', color: '#f97316', Icon: Users, task: 'Conduct thorough market research for my business. Calculate TAM/SAM/SOM, analyze trends, and produce a structured research report with actionable insights.' },

  // Content & Creative
  { id: 'content-strategist', name: 'Content Strategist', category: 'Content & Creative', description: 'Plans editorial calendars, content pillars, distribution strategy, and repurposing frameworks.', model: 'claude-sonnet-4-6', color: '#e1306c', Icon: Layout, task: 'Build me a content strategy — editorial calendar, content pillars, distribution channels, and a framework for repurposing content across platforms.' },
  { id: 'blog-writer', name: 'Blog Writer', category: 'Content & Creative', description: 'Researches and writes long-form SEO blog posts, articles, and thought leadership content.', model: 'claude-sonnet-4-6', color: '#e1306c', Icon: BookOpen, task: 'Write high-quality, SEO-optimized long-form blog posts and articles. Research the topic thoroughly and write in an engaging, authoritative voice.' },
  { id: 'copywriter', name: 'Copywriter', category: 'Content & Creative', description: 'Writes high-converting landing page copy, ads, headlines, and value propositions.', model: 'claude-sonnet-4-6', color: '#e1306c', Icon: Type, task: 'Write high-converting copy — landing pages, ad copy, headlines, and value propositions that speak directly to customer pain points and drive action.' },
  { id: 'social-media-manager', name: 'Social Media Manager', category: 'Content & Creative', description: 'Creates platform-specific posts, captions, hashtag strategies, and content calendars.', model: 'claude-sonnet-4-6', color: '#e1306c', Icon: Share2, task: 'Manage my social media content. Create platform-specific posts, captions, hashtag strategies, and a content calendar that builds engagement and following.' },
  { id: 'video-script', name: 'Video Script Writer', category: 'Content & Creative', description: 'Writes YouTube scripts, TikTok hooks, explainer videos, and podcast outlines.', model: 'claude-sonnet-4-6', color: '#e1306c', Icon: Video, task: 'Write compelling video scripts — YouTube long-form, TikTok hooks, explainer videos, and podcast episode outlines with strong openings and clear structure.' },
  { id: 'ghostwriter', name: 'Ghostwriter', category: 'Content & Creative', description: 'Writes in your voice — articles, LinkedIn posts, books, speeches, and newsletters.', model: 'claude-sonnet-4-6', color: '#e1306c', Icon: Ghost, task: 'Ghost-write content in my voice. First, ask me about my tone, style, and audience. Then write articles, LinkedIn posts, newsletters, or speeches that sound authentically like me.' },
  { id: 'creative-director', name: 'Creative Director', category: 'Content & Creative', description: 'Provides creative direction for campaigns, content, and brand storytelling.', model: 'claude-sonnet-4-6', color: '#e1306c', Icon: Paintbrush, task: 'Act as my creative director. Provide creative direction for campaigns, review content concepts, and guide our brand storytelling to be more compelling and memorable.' },

  // Research
  { id: 'research-analyst', name: 'Research Analyst', category: 'Research', description: 'Deep research on any topic — compiles sources, synthesizes findings, and produces structured reports.', model: 'gpt-4o', color: '#4285f4', Icon: Search, task: 'Research any topic I give you in depth. Compile sources, synthesize the most important findings, and produce a structured, comprehensive report with clear conclusions.' },
  { id: 'academic-researcher', name: 'Academic Researcher', category: 'Research', description: 'Literature reviews, citation analysis, methodology design, and academic writing.', model: 'claude-sonnet-4-6', color: '#4285f4', Icon: GraduationCap, task: 'Help me with academic research — conduct literature reviews, analyze citations, suggest methodology, and assist with rigorous academic writing.' },
  { id: 'fact-checker', name: 'Fact Checker', category: 'Research', description: 'Verifies claims, cross-references sources, and flags misinformation.', model: 'gpt-4o', color: '#4285f4', Icon: CheckSquare, task: 'Fact-check any claims I give you. Cross-reference with reliable sources, flag potential misinformation, and give me a clear verdict on accuracy.' },
  { id: 'news-monitor', name: 'News Monitor', category: 'Research', description: 'Tracks topics, summarizes daily news, and surfaces relevant developments.', model: 'gpt-4o', color: '#4285f4', Icon: Newspaper, task: 'Monitor news on topics I care about. Summarize the most important daily developments, surface emerging trends, and flag anything that needs my attention.' },
  { id: 'survey-analyst', name: 'Survey Analyst', category: 'Research', description: 'Designs surveys, analyzes results, and extracts actionable insights.', model: 'claude-sonnet-4-6', color: '#4285f4', Icon: BarChart2, task: 'Design surveys, analyze results, and extract the most actionable insights. Help me turn raw data into clear conclusions and recommendations.' },

  // Engineering
  { id: 'software-architect', name: 'Senior Software Architect', category: 'Engineering', description: 'Designs system architecture, reviews technical decisions, and produces architecture diagrams and ADRs.', model: 'claude-sonnet-4-6', color: '#1d9e75', Icon: Code2, task: 'Act as my senior software architect. Design system architecture, review technical decisions, write ADRs, and help me make the right technical trade-offs.' },
  { id: 'fullstack-dev', name: 'Full Stack Developer', category: 'Engineering', description: 'Implements features across frontend and backend with clean, production-ready code.', model: 'claude-sonnet-4-6', color: '#1d9e75', Icon: Layout, task: 'Implement features across the full stack. Write clean, production-ready code with proper error handling, tests, and documentation.' },
  { id: 'code-reviewer', name: 'Code Reviewer', category: 'Engineering', description: 'Reviews pull requests for bugs, security issues, performance, and code quality.', model: 'claude-sonnet-4-6', color: '#1d9e75', Icon: GitMerge, task: 'Review my code thoroughly. Look for bugs, security vulnerabilities, performance issues, and code quality improvements. Be specific and constructive.' },
  { id: 'devops-engineer', name: 'DevOps Engineer', category: 'Engineering', description: 'Designs CI/CD pipelines, Kubernetes configs, Terraform, and infrastructure automation.', model: 'claude-sonnet-4-6', color: '#1d9e75', Icon: Server, task: 'Help me design and implement DevOps infrastructure — CI/CD pipelines, Kubernetes configurations, Terraform scripts, and automation workflows.' },
  { id: 'security-auditor', name: 'Security Auditor', category: 'Engineering', description: 'Identifies vulnerabilities, reviews code for OWASP issues, and produces security reports.', model: 'claude-sonnet-4-6', color: '#1d9e75', Icon: Shield, task: 'Audit my code and infrastructure for security vulnerabilities. Check for OWASP issues, insecure configurations, and produce a prioritized security report.' },
  { id: 'qa-engineer', name: 'QA Engineer', category: 'Engineering', description: 'Creates test plans, writes automated tests, and finds edge cases.', model: 'claude-sonnet-4-6', color: '#1d9e75', Icon: TestTube, task: 'Help me with QA — create comprehensive test plans, write automated tests, and think through edge cases and failure scenarios I might have missed.' },
  { id: 'technical-writer', name: 'Technical Writer', category: 'Engineering', description: 'Writes API docs, READMEs, runbooks, and developer guides.', model: 'claude-sonnet-4-6', color: '#1d9e75', Icon: FileCode, task: 'Write clear technical documentation — API references, READMEs, runbooks, and developer guides that help users understand and use the system effectively.' },
  { id: 'db-architect', name: 'Database Architect', category: 'Engineering', description: 'Designs schemas, optimizes queries, writes migrations, and advises on database selection.', model: 'claude-sonnet-4-6', color: '#1d9e75', Icon: Database, task: 'Help me design and optimize my database. Review schemas, optimize slow queries, write clean migrations, and advise on the best database technology for my use case.' },

  // Finance
  { id: 'financial-analyst', name: 'Financial Analyst', category: 'Finance', description: 'DCF models, financial statement analysis, valuation, and investment memos.', model: 'gpt-4o', color: '#f59e0b', Icon: LineChart, task: 'Perform financial analysis — build DCF models, analyze financial statements, calculate valuations, and write investment memos with clear recommendations.' },
  { id: 'personal-finance', name: 'Personal Finance Advisor', category: 'Finance', description: 'Budgeting, debt payoff strategies, savings plans, and financial goal setting.', model: 'claude-sonnet-4-6', color: '#f59e0b', Icon: PiggyBank, task: 'Help me with my personal finances. Create a budget, prioritize debt payoff, build a savings plan, and set concrete financial goals with a timeline.' },
  ...
  { id: 'tax-advisor', name: 'Tax Advisor', category: 'Finance', description: 'General tax strategy, deduction identification, and quarterly planning guidance.', model: 'claude-sonnet-4-6', color: '#f59e0b', Icon: Receipt, task: 'Help me with tax strategy — identify deductions I might be missing, plan for quarterly taxes, and optimize my tax position. General guidance only, not legal advice.' },
  { id: 'crypto-analyst', name: 'Crypto Analyst', category: 'Finance', description: 'Analyzes crypto markets, DeFi protocols, and blockchain project fundamentals.', model: 'gpt-4o', color: '#f59e0b', Icon: Bitcoin, task: 'Analyze crypto markets and blockchain projects. Review fundamentals, tokenomics, DeFi protocols, and market dynamics to help me make more informed decisions.' },

  // Legal
  { id: 'contract-reviewer', name: 'Contract Reviewer', category: 'Legal', description: 'Reviews contracts for risk, unusual clauses, and missing protections. Not legal advice.', model: 'claude-sonnet-4-6', color: '#6366f1', Icon: Scale, task: 'Review this contract for risk, unusual or one-sided clauses, and missing protections. Flag anything concerning and suggest better language. Not legal advice.' },
  { id: 'legal-researcher', name: 'Legal Researcher', category: 'Legal', description: 'Researches case law, statutes, and regulations on any topic. Not legal advice.', model: 'claude-sonnet-4-6', color: '#6366f1', Icon: BookOpen, task: 'Research the legal landscape on a topic I give you — relevant case law, statutes, and regulations. Produce a structured summary. Not legal advice.' },
  { id: 'privacy-officer', name: 'Privacy Officer', category: 'Legal', description: 'GDPR, CCPA, and data privacy compliance reviews and policy drafting.', model: 'claude-sonnet-4-6', color: '#6366f1', Icon: Lock, task: 'Help me with data privacy compliance — review my practices against GDPR and CCPA requirements, draft privacy policies, and identify gaps in my data handling.' },
  { id: 'ip-advisor', name: 'IP Advisor', category: 'Legal', description: 'Trademark, copyright, and patent strategy guidance. Not legal advice.', model: 'claude-sonnet-4-6', color: '#6366f1', Icon: Lightbulb, task: 'Advise me on intellectual property strategy — trademark, copyright, and patent considerations for my work. General guidance only, not legal advice.' },

  // Sales
  { id: 'sales-coach', name: 'Sales Coach', category: 'Sales', description: 'Trains on objection handling, discovery questions, closing techniques, and deal strategy.', model: 'claude-sonnet-4-6', color: '#ec4899', Icon: Target, task: 'Coach me on sales. Help me with objection handling, powerful discovery questions, closing techniques, and how to approach specific deals I am working on.' },
  { id: 'cold-outreach', name: 'Cold Outreach Specialist', category: 'Sales', description: 'Writes personalized cold emails, LinkedIn messages, and outreach sequences.', model: 'claude-sonnet-4-6', color: '#ec4899', Icon: MailOpen, task: 'Write highly personalized cold outreach — emails, LinkedIn messages, and multi-step sequences that feel human, relevant, and drive replies.' },
  { id: 'sales-strategist', name: 'Sales Strategist', category: 'Sales', description: 'Pipeline analysis, territory planning, quota modeling, and revenue forecasting.', model: 'gpt-4o', color: '#ec4899', Icon: TrendingUp, task: 'Help me with sales strategy — analyze my pipeline, plan territories, model quotas, and build accurate revenue forecasts I can present to leadership.' },
  { id: 'proposal-writer', name: 'Proposal Writer', category: 'Sales', description: 'Creates compelling sales proposals, RFP responses, and pitch decks.', model: 'claude-sonnet-4-6', color: '#ec4899', Icon: FileText, task: 'Write a compelling sales proposal or RFP response. Make it specific to the prospect, clearly articulate value, and have a strong call to action.' },
  { id: 'crm-analyst', name: 'CRM Analyst', category: 'Sales', description: 'Analyzes CRM data, identifies trends, and recommends pipeline improvements.', model: 'gpt-4o', color: '#ec4899', Icon: Database, task: 'Analyze my CRM data, identify trends and patterns in my pipeline, and recommend specific improvements to increase conversion rates and deal velocity.' },

  // HR & Recruiting
  { id: 'recruiter', name: 'Recruiter', category: 'HR & Recruiting', description: 'Writes job descriptions, screens candidates, and designs interview processes.', model: 'claude-sonnet-4-6', color: '#a855f7', Icon: Users, task: 'Help me recruit top talent — write compelling job descriptions, design structured interview processes, and help me evaluate and screen candidates effectively.' },
  { id: 'hr-advisor', name: 'HR Advisor', category: 'HR & Recruiting', description: 'Employee relations, performance management, compensation strategy, and culture building.', model: 'claude-sonnet-4-6', color: '#a855f7', Icon: UserCheck, task: 'Act as my HR advisor. Help me with employee relations, performance management frameworks, compensation strategy, and building a strong team culture.' },
  { id: 'interview-coach', name: 'Interview Coach', category: 'HR & Recruiting', description: 'Preps candidates for interviews with mock questions, feedback, and strategy.', model: 'claude-sonnet-4-6', color: '#a855f7', Icon: MessageSquare, task: 'Coach me for my upcoming job interview. Run mock interviews, give honest feedback on my answers, and help me tell compelling stories about my experience.' },
  { id: 'onboarding-designer', name: 'Onboarding Designer', category: 'HR & Recruiting', description: 'Creates employee onboarding plans, checklists, and 30/60/90-day frameworks.', model: 'claude-sonnet-4-6', color: '#a855f7', Icon: ClipboardList, task: 'Design a comprehensive employee onboarding experience — welcome plan, first-week checklist, and 30/60/90-day framework to set new hires up for success.' },

  // Customer Support
  { id: 'support-agent', name: 'Support Agent', category: 'Customer Support', description: 'Handles customer inquiries, resolves issues, and drafts empathetic responses.', model: 'claude-sonnet-4-6', color: '#229ed9', Icon: Headphones, task: 'Help me handle customer support. Draft empathetic, clear responses to customer inquiries and complaints. Always aim to resolve the issue and leave the customer feeling heard.' },
  { id: 'customer-success', name: 'Customer Success Manager', category: 'Customer Support', description: 'Builds success plans, handles renewals, and proactively prevents churn.', model: 'claude-sonnet-4-6', color: '#229ed9', Icon: Star, task: 'Act as my customer success manager. Help me build customer success plans, prepare for renewal conversations, and proactively identify accounts at risk of churn.' },
  { id: 'complaint-handler', name: 'Complaint Handler', category: 'Customer Support', description: 'De-escalates difficult customer situations and finds win-win resolutions.', model: 'claude-sonnet-4-6', color: '#229ed9', Icon: AlertCircle, task: 'Help me de-escalate difficult customer situations. Draft responses that acknowledge the issue, take responsibility where appropriate, and propose clear resolutions.' },

  // Education
  { id: 'tutor', name: 'Tutor', category: 'Education', description: 'Explains any subject at any level with patience, examples, and Socratic questioning.', model: 'claude-sonnet-4-6', color: '#0ea5e9', Icon: GraduationCap, task: 'Be my tutor. Explain any topic I ask about clearly, use real-world examples, ask Socratic questions to check my understanding, and adapt to my level.' },
  { id: 'curriculum-designer', name: 'Curriculum Designer', category: 'Education', description: 'Designs course structures, learning objectives, and educational content.', model: 'claude-sonnet-4-6', color: '#0ea5e9', Icon: Layout, task: 'Design a comprehensive curriculum or course. Define clear learning objectives, structure the content logically, and create engaging educational materials.' },
  { id: 'study-coach', name: 'Study Coach', category: 'Education', description: 'Creates study plans, summarizes material, generates practice questions and flashcards.', model: 'claude-sonnet-4-6', color: '#0ea5e9', Icon: BookOpen, task: 'Help me study more effectively. Create a structured study plan, summarize key material, generate practice questions, and create flashcards for spaced repetition.' },
  { id: 'language-teacher', name: 'Language Teacher', category: 'Education', description: 'Teaches any language through conversation, correction, and structured exercises.', model: 'claude-sonnet-4-6', color: '#0ea5e9', Icon: Globe, task: 'Teach me a language I want to learn. Start by assessing my level, then teach through conversation, correct my mistakes kindly, and provide structured exercises.' },

  // Health & Wellness
  { id: 'fitness-coach', name: 'Fitness Coach', category: 'Health & Wellness', description: 'Creates workout plans, tracks progress, and advises on training methodology.', model: 'claude-sonnet-4-6', color: '#22c55e', Icon: Dumbbell, task: 'Create a personalized workout plan based on my goals and current fitness level. Advise on exercise form, progressive overload, and recovery strategies.' },
  { id: 'nutrition-advisor', name: 'Nutrition Advisor', category: 'Health & Wellness', description: 'Meal planning, macro tracking, dietary guidance, and recipe suggestions. Not medical advice.', model: 'claude-sonnet-4-6', color: '#22c55e', Icon: Leaf, task: 'Help me with nutrition planning. Create meal plans, advise on macros, suggest healthy recipes, and help me build sustainable eating habits. Not medical advice.' },
  { id: 'wellness-coach', name: 'Mental Wellness Coach', category: 'Health & Wellness', description: 'Mindfulness, stress management, journaling prompts, and habit building. Not therapy.', model: 'claude-sonnet-4-6', color: '#22c55e', Icon: Heart, task: 'Support my mental wellness. Guide me through mindfulness practices, stress management techniques, journaling prompts, and habit-building strategies. Not therapy.' },
  { id: 'sleep-coach', name: 'Sleep Coach', category: 'Health & Wellness', description: 'Sleep hygiene, schedule optimization, and evidence-based sleep improvement strategies.', model: 'claude-sonnet-4-6', color: '#22c55e', Icon: Moon, task: 'Help me improve my sleep. Assess my current sleep habits, recommend evidence-based improvements, and create an optimized sleep schedule and bedtime routine.' },

  // Real Estate
  { id: 'real-estate-analyst', name: 'Real Estate Analyst', category: 'Real Estate', description: 'Property valuation, market analysis, investment metrics (cap rate, ROI, cash-on-cash).', model: 'gpt-4o', color: '#84cc16', Icon: Home, task: 'Analyze real estate investments for me. Calculate cap rate, ROI, cash-on-cash return, and help me evaluate whether a deal makes financial sense.' },
  { id: 'listing-copywriter', name: 'Listing Copywriter', category: 'Real Estate', description: 'Writes compelling property listings, descriptions, and marketing materials.', model: 'claude-sonnet-4-6', color: '#84cc16', Icon: FileText, task: 'Write compelling real estate listings. Highlight the property\'s best features, create an emotional connection for buyers, and make it stand out from competing listings.' },
  { id: 'deal-analyzer', name: 'Deal Analyzer', category: 'Real Estate', description: 'Analyzes real estate deals, runs numbers, and identifies risks and opportunities.', model: 'gpt-4o', color: '#84cc16', Icon: Calculator, task: 'Analyze this real estate deal thoroughly. Run all the numbers, identify risks and opportunities, and give me a clear buy/pass recommendation with reasoning.' },

  // E-commerce
  { id: 'product-listing', name: 'Product Listing Writer', category: 'E-commerce', description: 'Writes optimized product titles, descriptions, and bullet points for Amazon, Shopify, etc.', model: 'claude-sonnet-4-6', color: '#635bff', Icon: ShoppingBag, task: 'Write optimized product listings for my e-commerce store. Create compelling titles, detailed descriptions, and benefit-focused bullet points that drive conversions.' },
  { id: 'pricing-strategist', name: 'Pricing Strategist', category: 'E-commerce', description: 'Analyzes pricing, competitor positioning, and recommends pricing strategy.', model: 'gpt-4o', color: '#635bff', Icon: Tag, task: 'Help me develop my pricing strategy. Analyze my costs, competitive positioning, and customer value perception to find the optimal price points.' },
  { id: 'review-analyst', name: 'Review Analyst', category: 'E-commerce', description: 'Analyzes customer reviews to extract insights, sentiment, and product improvement ideas.', model: 'gpt-4o', color: '#635bff', Icon: MessageSquare, task: 'Analyze my customer reviews to extract key insights — common complaints, praise patterns, sentiment trends, and specific product improvements customers want.' },
  { id: 'inventory-planner', name: 'Inventory Planner', category: 'E-commerce', description: 'Forecasts demand, optimizes stock levels, and prevents stockouts and overstock.', model: 'gpt-4o', color: '#635bff', Icon: Package, task: 'Help me optimize inventory planning. Forecast demand, set reorder points, identify slow-moving stock, and prevent both stockouts and costly overstock situations.' },

  // Social Media
  { id: 'instagram-strategist', name: 'Instagram Strategist', category: 'Social Media', description: 'Grows Instagram presence with content strategy, engagement tactics, and Reels ideas.', model: 'claude-sonnet-4-6', color: '#e1306c', Icon: Share2, task: 'Help me grow my Instagram. Develop a content strategy, suggest Reels concepts, write captions, and advise on engagement tactics to build a real audience.' },
  { id: 'linkedin-creator', name: 'LinkedIn Creator', category: 'Social Media', description: 'Writes viral LinkedIn posts, thought leadership content, and profile optimization.', model: 'claude-sonnet-4-6', color: '#e1306c', Icon: Users, task: 'Help me build my LinkedIn presence. Write posts that drive engagement, develop thought leadership content, and optimize my profile to attract opportunities.' },
  { id: 'twitter-strategist', name: 'Twitter/X Strategist', category: 'Social Media', description: 'Crafts threads, growing a following, and building engagement on Twitter/X.', model: 'claude-sonnet-4-6', color: '#e1306c', Icon: MessageSquare, task: 'Help me grow on Twitter/X. Write compelling threads, develop a posting strategy, and help me build engagement and grow a relevant following.' },

  // SEO
  { id: 'seo-strategist', name: 'SEO Strategist', category: 'SEO', description: 'Keyword research, content gap analysis, technical SEO audits, and link building strategy.', model: 'gpt-4o', color: '#ff7000', Icon: Search, task: 'Build a comprehensive SEO strategy for my website. Conduct keyword research, identify content gaps, audit technical SEO issues, and plan link building.' },
  { id: 'on-page-optimizer', name: 'On-Page Optimizer', category: 'SEO', description: 'Optimizes existing content for search — titles, meta, headers, internal links, readability.', model: 'claude-sonnet-4-6', color: '#ff7000', Icon: Edit3, task: 'Optimize my existing content for search engines. Improve titles, meta descriptions, headers, internal linking, and readability to boost rankings.' },
  { id: 'backlink-researcher', name: 'Backlink Researcher', category: 'SEO', description: 'Identifies link building opportunities, outreach targets, and competitor link profiles.', model: 'gpt-4o', color: '#ff7000', Icon: Link, task: 'Research link building opportunities for my website. Identify high-quality sites to target, analyze competitor backlinks, and draft outreach templates.' },

  // Data & Analytics
  { id: 'data-analyst', name: 'Data Analyst', category: 'Data & Analytics', description: 'Analyzes datasets, identifies trends, builds reports, and answers business questions with data.', model: 'gpt-4o', color: '#06b6d4', Icon: BarChart3, task: 'Analyze data I share with you. Identify trends, surface anomalies, build structured reports, and answer specific business questions with clear data-backed conclusions.' },
  { id: 'bi-consultant', name: 'BI Consultant', category: 'Data & Analytics', description: 'Designs dashboards, KPI frameworks, and data visualization strategies.', model: 'gpt-4o', color: '#06b6d4', Icon: PieChart, task: 'Help me build a business intelligence strategy — design dashboards, define KPIs that matter, and create a data visualization framework that drives decisions.' },
  { id: 'python-data-scientist', name: 'Python Data Scientist', category: 'Data & Analytics', description: 'Writes Python for data analysis, visualization, machine learning, and automation.', model: 'claude-sonnet-4-6', color: '#06b6d4', Icon: Code, task: 'Write Python code for data analysis, visualization, and machine learning. Use pandas, numpy, matplotlib, scikit-learn, or whatever is appropriate.' },

  // Productivity
  { id: 'executive-assistant', name: 'Executive Assistant', category: 'Productivity', description: 'Manages tasks, drafts communications, schedules planning, and keeps you organized.', model: 'claude-sonnet-4-6', color: '#8b5cf6', Icon: ClipboardList, task: 'Act as my executive assistant. Help me manage tasks, draft professional communications, plan my schedule, and stay organized and on top of priorities.' },
  { id: 'project-manager', name: 'Project Manager', category: 'Productivity', description: 'Creates project plans, tracks milestones, manages risks, and keeps teams aligned.', model: 'claude-sonnet-4-6', color: '#8b5cf6', Icon: Calendar, task: 'Help me manage my project. Create a project plan with milestones, identify risks, track progress, and keep all stakeholders aligned and informed.' },
  { id: 'meeting-summarizer', name: 'Meeting Summarizer', category: 'Productivity', description: 'Turns meeting transcripts into action items, decisions, and structured summaries.', model: 'claude-sonnet-4-6', color: '#8b5cf6', Icon: MessageSquare, task: 'Summarize my meeting transcript into a clean, structured document with: key decisions made, action items with owners and due dates, and a brief executive summary.' },
  { id: 'task-prioritizer', name: 'Task Prioritizer', category: 'Productivity', description: 'Applies frameworks (Eisenhower, MoSCoW, RICE) to help you focus on what matters most.', model: 'claude-sonnet-4-6', color: '#8b5cf6', Icon: Filter, task: 'Help me prioritize my task list. Apply the Eisenhower matrix, MoSCoW, or RICE framework to help me focus on what will have the highest impact.' },

  // Personal
  { id: 'life-coach', name: 'Life Coach', category: 'Personal', description: 'Goal setting, accountability, mindset coaching, and personal development planning.', model: 'claude-sonnet-4-6', color: '#f43f5e', Icon: Star, task: 'Be my life coach. Help me set meaningful goals, build accountability systems, work through mindset blocks, and create a personal development plan.' },
  { id: 'career-advisor', name: 'Career Advisor', category: 'Personal', description: 'Resume review, job search strategy, career pivots, and professional development.', model: 'claude-sonnet-4-6', color: '#f43f5e', Icon: Briefcase, task: 'Advise me on my career. Review my resume, help me develop a job search strategy, think through potential pivots, and plan my professional development.' },
  { id: 'resume-writer', name: 'Resume Writer', category: 'Personal', description: 'Writes and optimizes resumes and LinkedIn profiles for target roles.', model: 'claude-sonnet-4-6', color: '#f43f5e', Icon: FileText, task: 'Write and optimize my resume for the roles I am targeting. Make it ATS-friendly, highlight my strongest achievements, and ensure it tells a compelling story.' },
  { id: 'travel-planner', name: 'Travel Planner', category: 'Personal', description: 'Creates detailed itineraries, finds deals, and handles all aspects of trip planning.', model: 'claude-sonnet-4-6', color: '#f43f5e', Icon: Map, task: 'Plan my trip in detail. Create a day-by-day itinerary, recommend accommodation and restaurants, suggest what not to miss, and help me get the best value.' },
  { id: 'personal-shopper', name: 'Personal Shopper', category: 'Personal', description: 'Finds products matching your criteria, compares options, and makes recommendations.', model: 'gpt-4o', color: '#f43f5e', Icon: ShoppingCart, task: 'Help me find the best products for my needs. Understand my criteria, compare options, and make clear recommendations with reasoning.' },
]
